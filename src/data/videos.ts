...
export interface VideoEntry {
  ...
  kind: VideoKind;
  year: number;
  /** Fecha real de la cinta. Ordena el archivo por lo último que se filmó. */
  recordedAt: string;
...
export const videos: VideoEntry[] = [
  {
    ...
    durationLabel: '00:53',
    src: '/media/videos/entrevista-yolanda-web-20260907.mp4',
  ...
  },
  {
    ...
    durationLabel: '01:38',
    src: '/media/videos/entrevista-beto-web-20260907.mp4',
  ...
  },
  {
    ...
    durationLabel: '00:26',
    src: '/media/videos/entrevista-lalo-web-20260907.mp4',
  ...
  },
  {
    ...
    durationLabel: '00:29',
    src: '/media/videos/entrevista-maricela-web-20260907.mp4',
  ...
  },
  {
    ...
    durationLabel: '00:43',
    src: '/media/videos/entrevista-missael-vhs-web-20260907.mp4',
  ...
  },
  {
    ...
    durationLabel: '01:08',
    src: '/media/videos/drummond-infinniguard-web-20260907.mp4',
  ...
  },
  {
    ...
    kind: 'corporativo',
    year: 2026,
    recordedAt: '2026-01-27',
    durationLabel: '01:14',
    src: '/media/videos/recepcion-250-toneladas-web-20260907.mp4',
  ...
  },
  {
    ...
    recordedAt: '2026-04-23',
    durationLabel: '00:40',
    src: '/media/videos/parto-web-20260907.mp4',
